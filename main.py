...
def absensiWajah():
    ...
    while True:
        ...
        cv2.imshow('lihat ke kamera', frame)
...
judul = tk.Label(root, text="absen wajah", font=("Roboto",34),bg="#242526", fg="white")
canvas.create_window(350, 80, window=judul)

made = tk.Label(root, text="main Contributor : dewakuli", font=("Times New Roman",13), bg="black",fg="white")
...
label3 = tk.Label(root, text="jurusan", font="Roboto", fg="white", bg="black")
